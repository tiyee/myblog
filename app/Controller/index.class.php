...
//	$delete	 	=  $db->query("DELETE FROM Persons WHERE Id = :id",array("id"=>"6"));\
	$this->d($person, "All persons");
	$this->d($firstname, "Fetch Single value, The firstname");
	$this->d($id_age, "Single Row, Id and Age");
	$this->d($ages, "Fetch Column, Numeric Index");


}

public function d($v,$t)
	{
		echo '<pre>';
		echo '<h1>' . $t. '</h1>';
		var_dump($v);
